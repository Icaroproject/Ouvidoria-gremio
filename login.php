...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($acao === 'cadastro') {
        ...
        if ($nome === '' || $cpf === '' || $email === '' || $senha === '' || $confirmar === '') {
            ...
            header('Location: login.php#cadastro');
            exit;
        }
      ...
      <div class="auth-panel active" id="login">
        ...
        <form method="post" autocomplete="off" id="formLogin">
          ...
          <div style="text-align:right;margin-bottom:24px">
            <a href="forgot_password.php" style="font-size:0.82rem;color:var(--laranja);text-decoration:none;font-weight:600">Esqueci minha senha</a>
          </div>
